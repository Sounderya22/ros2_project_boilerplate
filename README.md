...
This repository contains the boilderplate for ros2 based project

## Project Contributor
[Sounderya Varagur Venugopal](https://github.com/Sounderya22)
## Project Overview
This project proposes an 

## UML
The initial diagrams can be found [here](https://github.com/Sounderya22/ros2_project_boilerplate/blob/main/UML/initial)
## Product backlog
The product backlog can be found [here](https://docs.google.com).
## Sprint Planning
The sprint planning sheet can be found [here](https://docs.google.com).
...
```bash
# Download the code:
  git clone https://github.com/Sounderya22/ros2_project_boilerplate
  cd ros2_project_boilerplate/
